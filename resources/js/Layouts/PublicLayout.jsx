...
export default function PublicLayout({ children }) {
    ...
    const waNumero  = waLink(config_publica?.whatsapp_contacto);
    ...
    return (
        <div className="flex min-h-screen flex-col bg-bg font-sans text-content">
            ...
            {/* Banner alerta — carrusel estático */}
            <AlertaCarrusel />
            ...
            {waNumero && <WhatsAppBoton href={waNumero} />}
...
// Normaliza cualquier formato de teléfono peruano a https://wa.me/51XXXXXXXXX
function waLink(raw) {
    if (!raw) return null;
    const digits = raw.replace(/\D/g, '');
    if (!digits) return null;
    // Si ya tiene código de país 51 (11 dígitos) úsalo directamente
    // Si son 9 dígitos (sin código) agregar 51
