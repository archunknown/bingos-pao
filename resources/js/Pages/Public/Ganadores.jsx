...
/* Paleta de avatares dentro del sistema de tokens (inline styles para evitar clases dinámicas) */
const AVATAR_PALETTES = [
    { bg: '#D4AF37', text: '#0D0D0D' }, // gold
    { bg: '#C0392B', text: '#ffffff' }, // danger
    { bg: '#27AE60', text: '#ffffff' }, // success
    { bg: '#B8960C', text: '#0D0D0D' }, // gold-dark
    { bg: '#F5F0E8', text: '#0D0D0D' }, // cream
    { bg: '#888888', text: '#0D0D0D' }, // muted
];
            ...
            <div className="mt-4 flex items-center justify-between gap-2">
                ...
                {ganador.fecha_sorteo && (
                    <span className="text-xs text-muted">
                        {new Date(ganador.fecha_sorteo).toLocaleDateString('es-PE', {
                            dateStyle: 'medium',
                        })}
                    </span>
                )}
...
function EmptyState({ filtrado, onLimpiar }) {
    return (
        <div className="border border-gold/10 bg-surface px-6 py-16 text-center">
